...
- **[setup-linear-workflow](./skills/engineering/setup-linear-workflow/SKILL.md)** — Configure an optional Linear-backed unattended agent workflow for projects that use Linear states and labels as an execution queue.
...
- **[to-prd](./skills/engineering/to-prd/SKILL.md)** — Turn the current conversation context into a PRD and submit it to the configured issue tracker. No interview — just synthesizes what you've already discussed.
